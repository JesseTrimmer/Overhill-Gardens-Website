        ...
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: 'clamp(3rem,8vw,7rem) clamp(2rem,6vw,6rem)' }}>
          ...
          <div style={{ display: 'flex', gap: '3rem', marginTop: '4rem', paddingTop: '2.5rem', borderTop: '1px solid var(--border)' }}>
            {[
              ...
              <div key={s.label}>
                <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '2.4rem', fontWeight: 300, color: 'var(--moss)', lineHeight: 1 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2px', background: 'var(--parchment-dark)' }}>
        <Reveal direction="left" style={{ height: '100%' }}>
          <Link
            to="/nursery"
            className="lift-card"
            style={{ display: 'block', height: '100%', background: 'var(--white)', padding: '4rem clamp(2rem,5vw,5rem)', position: 'relative', overflow: 'hidden' }}
          >
        ...
        <Reveal direction="right" style={{ height: '100%' }}>
          <Link
            to="/landscaping"
            className="lift-card"
            style={{ display: 'block', height: '100%', background: 'var(--moss)', padding: '4rem clamp(2rem,5vw,5rem)' }}
          >
